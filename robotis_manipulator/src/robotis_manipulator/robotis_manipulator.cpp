...
void RobotisManipulator::addJoint2(Name my_name,
                                  Name parent_name,
                                  Eigen::Vector3d relative_position,
                                  Eigen::Matrix3d relative_orientation,
                                  Eigen::Vector3d axis_of_rotation,
                                  ...
                                  Eigen::Vector3d center_of_mass)
{
  manipulator_.addJoint2(my_name, parent_name,
                        relative_position, relative_orientation, axis_of_rotation, joint_actuator_id,
                        max_position_limit, min_position_limit, coefficient, mass,
                        inertia_tensor, center_of_mass);
}
...
void RobotisManipulator::addTool2(Name my_name,
                                 Name parent_name,
                                 Eigen::Vector3d relative_position,
                                 Eigen::Matrix3d relative_orientation,
                                 double max_position_limit,
                                 ...
                                 Eigen::Vector3d center_of_mass)
{
  manipulator_.addTool2(my_name, parent_name,
...
void RobotisManipulator::addToolActuator2(Name actuator_name, ToolActuator *tool_actuator, const void *arg)
{
  tool_actuator_.insert(std::make_pair(actuator_name, tool_actuator));
  // if(tool_actuator_.find(actuator_name) != tool_actuator_.end())
  // {
  ...
  //   //error
  // }
  manipulator_.setComponentActuatorName(manipulator_.findComponentName(),actuator_name);
  tool_actuator_added_stete_ = true;
}
